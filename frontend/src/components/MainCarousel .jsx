...
const items = [
    <img src="https://www.sliderrevolution.com/wp-content/uploads/2023/06/Xoos.jpg" className="rounded-xl w-full h-[500px] object-cover" alt="Slide 1" data-value="1" />,
    <img src="/hero_photo/4.webp" className="rounded-xl w-full h-[500px] object-cover" alt="Slide 4" data-value="4" />,
    <img src="/hero_photo/1.png" className="rounded-xl w-full h-[500px] object-cover" alt="Slide 6" data-value="6" />,
